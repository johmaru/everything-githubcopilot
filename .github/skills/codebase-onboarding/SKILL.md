...
Systematically analyze an unfamiliar codebase and produce a structured onboarding guide. Designed for developers joining a new project or setting up GitHub Copilot in an existing repo for the first time.

## When to Use

- First time opening a project with GitHub Copilot
- Joining a new team or repository
- User asks "help me understand this codebase"
- User asks to generate a `copilot-instructions.md` for a project
...
#### Output 2: Starter `copilot-instructions.md`

Generate or update a project-specific `copilot-instructions.md` based on detected conventions. If ``copilot-instructions.md`` already exists, read it first and enhance it — preserve existing project-specific instructions and clearly call out what was added or changed.
...
3. **Respect existing `copilot-instructions.md`** — if one already exists, enhance it rather than replacing it. Call out what's new vs existing.
...
- Generating a `copilot-instructions.md` that's longer than 100 lines — keep it focused
...
**Action**: Run full 4-phase workflow → produce Onboarding Guide + Starter `copilot-instructions.md`
**Output**: Onboarding Guide printed directly to the conversation, plus a ``copilot-instructions.md`` written to the project root

### Example 2: Generate `copilot-instructions.md` for existing project
**User**: "Generate a `copilot-instructions.md` for this project"
**Action**: Run Phases 1-3, skip Onboarding Guide, produce only `copilot-instructions.md`
**Output**: Project-specific ``copilot-instructions.md`` with detected conventions

### Example 3: Enhance existing `copilot-instructions.md`
**User**: "Update the `copilot-instructions.md` with current project conventions"
**Action**: Read existing `copilot-instructions.md`, run Phases 1-3, merge new findings
**Output**: Updated ``copilot-instructions.md`` with additions clearly marked
