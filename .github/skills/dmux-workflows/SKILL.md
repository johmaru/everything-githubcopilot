...
- Coordinating work across GitHub Copilot, Codex, and other harnesses
...
- Supports: GitHub Copilot, Codex, OpenCode, Cline, Gemini, Qwen
...
```
Pane 1 (GitHub Copilot): "Review the security of the auth module"
Pane 2 (Codex): "Refactor the utility functions for performance"
Pane 3 (GitHub Copilot): "Write E2E tests for the checkout flow"
```
...
| **GitHub Copilot Task tool** | In-process subagent spawning | Programmatic parallelism within a session |
| **Codex multi-agent** | Built-in agent roles | Codex-specific parallel work |

## EGP Helper

EGP now includes a helper for external tmux-pane orchestration with separate git worktrees:
...
```json
{
  ...
  "seedPaths": [
    ...
    ".github/plan/workflow-e2e-test.json"
  ],
