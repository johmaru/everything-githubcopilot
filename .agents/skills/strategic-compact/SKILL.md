...
| Persists | Lost |
|----------|------|
| `copilot-instructions.md` instructions | Intermediate reasoning and analysis |
| TodoWrite task list | File contents you previously read |
| Memory files (project memory) | Multi-step conversation context |
...
- **`copilot-instructions.md` files** — Always loaded, keep lean
...
- Same rules in both `.github/instructions/` and project `.github/rules/`
- Skills that repeat `copilot-instructions.md` instructions
