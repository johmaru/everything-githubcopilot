...
请使用 [GitHub Security Advisories](https://github.com/johmaru/everything-githubcopilot/security/advisories) 或联系维护者，邮件中需包含：
...
* **AgentShield**：扫描您的代理配置以查找漏洞 — `npx agentshield scan`
