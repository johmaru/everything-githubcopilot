...
A formal evaluation framework for GitHub Copilot sessions, implementing eval-driven development (EDD) principles.

## When to Activate

- Setting up eval-driven development (EDD) for AI-assisted workflows
- Defining pass/fail criteria for GitHub Copilot task completion
...
```
Creates eval definition file at `.github/evals/feature-name.md`
...
- `.github/evals/<feature>.md` definition
- `.github/evals/<feature>.log` run history
