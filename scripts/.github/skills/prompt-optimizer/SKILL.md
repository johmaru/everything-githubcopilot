...
Analyze a draft prompt, critique it, match it to EGP ecosystem components,
...
- User says "what's the best way to ask GitHub Copilot to..."
- User says "优化prompt", "改进prompt", "怎么写prompt", "帮我优化这个指令"
- User pastes a draft prompt and asks for feedback or enhancement
- User says "I don't know how to prompt for this"
- User says "how should I use EGP for..."
...
- User is asking about EGP configuration (use `configure-ecc` instead)
...
1. Check if a ``copilot-instructions.md`` exists in the working directory — read it for project conventions
...
### Phase 3: EGP Component Matching

Map intent + scope + tech stack (from Phase 0) to specific EGP components.
...
### Section 2: Recommended EGP Components
...
A compact version for experienced EGP users. Vary by intent type:
...
- "Optimize this prompt for EGP"
- "Rewrite this prompt so GitHub Copilot uses the right commands"
- "帮我优化这个指令"
- "How should I prompt EGP for this task?"
...
|-----------|------------------|
| `configure-ecc` | User hasn't set up EGP yet |
